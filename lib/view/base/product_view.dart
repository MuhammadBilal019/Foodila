  ...
  Widget build(BuildContext context) {
    ...
    return !_isNull ? _length > 0 ? GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        ...
        childAspectRatio: GetPlatform.isDesktop ? isRestaurant?isFavorite?5:5:isFavorite?MediaQuery.of(context).size.width >=900?0.9:1:5.9 : isRestaurant?1.5:isFavorite?3:3,
