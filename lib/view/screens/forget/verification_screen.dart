  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(child: Center(child: Scrollbar(child: SingleChildScrollView(
        ...
        child: Center(child: SizedBox(width: MediaQuery.of(context).size.width*0.8, child: GetBuilder<AuthController>(builder: (authController) {
          return Column(children: [
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 9, vertical: 35),
