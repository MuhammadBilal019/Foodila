...
class AppConstants {
  ...
  //https://demo.6amtech.com/stackfood
  //https://gastro.foodila.de
  static const String BASE_URL = 'https://gastro.foodila.de';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.english, languageName: 'German', countryCode: 'DE', languageCode: 'de'),
